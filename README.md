...
Класс "Cart" содержит продукты из класса "Price" и условия типа "Condition" для рассчета итоговой цены
Имеются 3 вида условия от "Condition", это "ConjCondition","DisjCondition","CountCondition"
